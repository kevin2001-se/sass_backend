...
class ComprobantesPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = collect([
            ...
            ['name' => 'comprobantes.solicitar_baja', 'label' => 'Solicitar baja de comprobantes', 'description' => 'Solicitar baja interna de comprobantes aceptados'],
            ['name' => 'comprobantes.ver_bajas', 'label' => 'Ver historial de bajas', 'description' => 'Consultar historial de bajas internas de comprobantes'],
            ...
            ['name' => 'comunicaciones_baja.ver', 'label' => 'Ver comunicaciones de baja', 'description' => 'Consultar comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.generar', 'label' => 'Generar comunicaciones de baja', 'description' => 'Agrupar comprobantes pendientes en una comunicacion de baja'],
            ['name' => 'comunicaciones_baja.anular', 'label' => 'Anular comunicaciones de baja', 'description' => 'Anular comunicaciones de baja antes de enviarlas a SUNAT'],
            ['name' => 'comunicaciones_baja.enviar_sunat', 'label' => 'Enviar comunicaciones de baja a SUNAT', 'description' => 'Enviar comunicaciones de baja usando Greenter'],
            ['name' => 'comunicaciones_baja.reenviar_sunat', 'label' => 'Reenviar comunicaciones de baja a SUNAT', 'description' => 'Reintentar envio SUNAT de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.descargar_xml', 'label' => 'Descargar XML de comunicaciones de baja', 'description' => 'Descargar XML privado de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.consultar_ticket', 'label' => 'Consultar ticket de comunicaciones de baja', 'description' => 'Consultar ticket SUNAT y obtener CDR de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.descargar_cdr', 'label' => 'Descargar CDR de comunicaciones de baja', 'description' => 'Descargar CDR privado de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.xml.descargar', 'label' => 'Descargar XML de comunicaciones de baja', 'description' => 'Descargar XML privado de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.cdr.descargar', 'label' => 'Descargar CDR de comunicaciones de baja', 'description' => 'Descargar CDR privado de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.pdf.generar', 'label' => 'Generar PDF de comunicaciones de baja', 'description' => 'Generar PDF A4 privado de comunicaciones de baja'],
            ['name' => 'comunicaciones_baja.pdf.descargar', 'label' => 'Descargar PDF de comunicaciones de baja', 'description' => 'Descargar PDF A4 privado de comunicaciones de baja'],
