...
use App\Services\NotaDebitoDocumentoService;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;

class NotaDebitoDocumentoController extends Controller
{
    public function __construct(private readonly NotaDebitoDocumentoService $service)
    {
    }
    ...
    public function generarPdfA4(Request $request, int $id)
    {
        try {
            ...
            return $this->errorResponse($e, 'No se pudo generar el PDF de la nota de debito.');
        }
    ...
    public function generarTicket80(Request $request, int $id)
    {
        try {
            ...
            return $this->errorResponse($e, 'No se pudo generar el ticket de la nota de debito.');
        }
    ...
    public function generarFormatos(Request $request, int $id)
    {
        try {
            ...
            return $this->errorResponse($e, 'No se pudieron generar los formatos de la nota de debito.');
        }
