...
class UpdateProveedorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numero_documento' => ['required', 'string', 'max:20', Rule::unique('proveedores', 'numero_documento')->where('empresa_id', $this->attributes->get('empresa')?->id)->ignore($this->route('proveedor'))],
