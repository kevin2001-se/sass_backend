...
<div class="header">
    ...
    <div class="box">
        <div class="title">NOTA DE D&Eacute;BITO ELECTR&Oacute;NICA</div>
...
<table>
    ...
    <tr>
        ...
        <th class="right" style="width: 12%">IGV</th>
    ...
    @foreach($detalles as $detalle)
        <tr>
            ...
            <td class="right">S/ {{ number_format((float) $detalle->subtotal, 2) }}</td>
            <td class="right">S/ {{ number_format((float) $detalle->igv, 2) }}</td>
...
@if($nota->observacion)
    <div class="section" style="margin-top: 14px;">
        <div class="section-title">Observaci&oacute;n</div>
        {{ $nota->observacion }}
    </div>
@endif
