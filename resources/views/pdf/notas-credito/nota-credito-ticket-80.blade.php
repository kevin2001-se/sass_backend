...
<div class="line"></div>
<div class="center bold">NOTA DE CR&Eacute;DITO ELECTR&Oacute;NICA</div>
...
<table>
    @foreach($detalles as $detalle)
        ...
        <tr>
            <td>{{ number_format((float) $detalle->cantidad, 4) }} {{ $detalle->unidad_medida }} x S/ {{ number_format((float) $detalle->precio_unitario, 2) }}</td>
